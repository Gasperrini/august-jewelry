        ...
        <div class="col-md-3">
            <div class="tile p-0">
                <ul class="nav flex-column nav-tabs user-tabs">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#images" data-toggle="tab">Nuotraukos</a></li>
                    <li class="nav-item"><a class="nav-link" href="#attributes" data-toggle="tab">Atributai</a></li>
                </ul>
            </div>
        </div>
        <div class="col-md-9">
            <div class="tab-content">
                        ...
                        <form action="{{ route('admin.products.update') }}" method="POST" role="form">
                            ...
                            <div class="tile-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label" for="sale_price">Speciali kaina</label>
                                            <input
                                                class="form-control"
                                                type="text"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label" for="quantity">Turimas kiekis</label>
                                            <input
                                                class="form-control @error('quantity') is-invalid @enderror"
                                                type="number"
                                                placeholder="Įveskite turimą prekės kiekį"
                                                id="quantity"
                                                name="quantity"
                            ...
                            <div class="tile-footer">
                                <div class="row d-print-none mt-2">
                                    <div class="col-12 text-right">
                                        <button class="btn btn-success" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Atnaujinti produktą</button>
                ...
                <div class="tab-pane" id="images">
                    <div class="tile">
                        <h3 class="tile-title">Nuotraukos</h3>
                        <hr>
                        <div class="tile-body">
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <div class="row d-print-none mt-2">
                                <div class="col-12 text-right">
                                    <button class="btn btn-success" type="button" id="uploadButton">
                                        <i class="fa fa-fw fa-lg fa-upload"></i>Įkelkite nuotraukas
                                    </button>
                                </div>
                            </div>
                            @if ($product->images)
    ...
    <script>
        ...
        $( document ).ready(function() {
            ...
            myDropzone.on("queuecomplete", function (file) {
                ...
                showNotification('Atlikta', 'Visų prekių nuotraukos įkeltos!', 'success', 'fa-check');
            });
            $('#uploadButton').click(function(){
                if (myDropzone.files.length === 0) {
                    showNotification('Klaida', 'Pasirinkite norimą ikelti failą.', 'danger', 'fa-close');
                } else {
