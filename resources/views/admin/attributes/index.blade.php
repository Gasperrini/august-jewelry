...
@section('content')
    <div class="app-title">
        ...
        <a href="{{ route('admin.attributes.create') }}" class="btn btn-primary pull-right">Pridėti atributą</a>
    </div>
                ...
                <div class="tile-body">
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        <tr>
                            <th> Kodas </th>
                            <th> Pavadinimas </th>
                            <th class="text-center"> Pasirinkimo tipas </th>
                            <th class="text-center"> Filtruojamas </th>
                            <th class="text-center"> Privalomas </th>
